...
public class ItemServiceImpl implements ItemService {
	...
	public E3Result deleteItemByIds(String[] ids) {
		int deleteItemByIds = itemMapper.deleteItemByIds(ids);
		return E3Result.ok();
	}
